...
const traaittCASHUtils = require('../').CryptoNote
const cnUtil = new traaittCASHUtils(require('../config.json'))

console.log('Using Crypto: %s', traaittCASHCrypto.type)
...
describe('Wallets', () => {
  ...
  const testAddress = 'TRv3nzumGSpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzQjvRqX'
  ...
  describe('Message Signing', () => {
    it('sign a string message', () => {
      const signature = cnUtil.signMessage('this is a test message', 'TRuwWQ7dBCWnm3rwdLmtUbzMnJ3bJy4G851T184W8gf2f9zrsdC3rPLxKmtG5rmFfa91uXDYRUkYKZvrKNXzXqfKmVvSYVXkx', 'd4c7e338d7efe0468b6498dd2f96620fad6b103d1a70dea76bab4de9db9c0a0b')

      assert((signature))
    })

    it('sign an object-based message', () => {
      const signature = cnUtil.signMessage({ mac: 'deadbeef', amount: 10 }, 'TRuwWQ7dBCWnm3rwdLmtUbzMnJ3bJy4G851T184W8gf2f9zrsdC3rPLxKmtG5rmFfa91uXDYRUkYKZvrKNXzXqfKmVvSYVXkx', 'd4c7e338d7efe0468b6498dd2f96620fad6b103d1a70dea76bab4de9db9c0a0b')

      assert((signature))
    })

    it('verify signature - string message', () => {
      const isValid = cnUtil.verifyMessageSignature('this is a test message', 'TRuwWQ7dBCWnm3rwdLmtUbzMnJ3bJy4G851T184W8gf2f9zrsdC3rPLxKmtG5rmFfa91uXDYRUkYKZvrKNXzXqfKmVvSYVXkx', '9ef44c5b3ffe86e31b126e284227953bdb78714b40af4e43c66d4e4a72a3150096b2b8e6a974e5fbc5a6ed700381f5356e6f80ad0ca62b020382f37b00d4d401')

      assert(isValid)
    })

    it('verify signature - object-based message', () => {
      const isValid = cnUtil.verifyMessageSignature({ mac: 'deadbeef', amount: 10 }, 'TRuwWQ7dBCWnm3rwdLmtUbzMnJ3bJy4G851T184W8gf2f9zrsdC3rPLxKmtG5rmFfa91uXDYRUkYKZvrKNXzXqfKmVvSYVXkx', 'f111faac9365c62eaf016364e9db6ec50060f379e9b0e480ba1dc41993c3380f55a6f4b10bb3e1d18ee0aa139157ee657a451746e5f6358199a7425e4f65af0c')
...
describe('Transactions', () => {
  describe('Create Transaction Outputs', () => {
    it('Amount: 1234567', () => {
      ...
      const transfers = cnUtil.createTransactionOutputs('TRv3nzumGSpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzQjvRqX', amount)
  ...
  describe('Transaction Creation', () => {
    it('generate a transaction', () => {
      const madeOutputs = cnUtil.createTransactionOutputs('TRv3nzumGSpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzQjvRqX', 90)
      const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94'
      const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909'
      const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b'
      const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418'
