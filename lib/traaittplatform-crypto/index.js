// Copyright (c) 2019, The TurtCoin Developers
...
/**
 * Module of traaittCASH Cryptographic Methods
 * @module Crypto
 * @class
 */
class Crypto {
...
function loadBrowserWASM () {
  ...
  try {
    const Self = window.traaittCASHCrypto()
...
function loadNativeAddon () {
  try {
    const Self = require('traaittcash-crypto')
...
function loadNativeJS () {
  try {
    const Self = require('./@trrxitte/traaittcash-crypto.js')()
...
function loadWASMJS () {
  ...
  try {
    const Self = require('./@trrxitte/traaittcash-crypto-wasm.js')()
